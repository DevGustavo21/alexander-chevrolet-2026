...
export function waTestDriveMessage(vehicleName) {
  return `Hola Alexander, me gustaría agendar una prueba de manejo del Chevrolet ${vehicleName}. ¿Qué disponibilidad tenés esta semana?`;
}
